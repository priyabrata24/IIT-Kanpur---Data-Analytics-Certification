library(dplyr)
#----------------
setwd("D:/My Docs/IIT Kanpur - Data Analytics/01 IIT KANPUR CERTIFICATE/Projects/P Project Problem -1 Real Estate")
getwd()
#----------------
...
class(PP_test_final)
write.csv(PP_test_final, "Dr_P_Adhikary_final.csv")
#----------------
library(ggplot2)
#----------------
